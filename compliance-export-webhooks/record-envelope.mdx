...
description: "The shape of the compliance_record.ready event Klariqo sends when a signed record is ready: call metadata, event id, and the expiring signed vCon URL."
---
