...
description: "Register a webhook endpoint in the Klariqo dashboard, receive your signing secret, and pass the verification challenge before real records are delivered."
---
