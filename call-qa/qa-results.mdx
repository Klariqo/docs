---
title: "QA results"
description: "How to read a Klariqo QA result: call status, overall score from 0 to 100, compliance status, and what unscored calls like voicemail mean for reporting."
---
