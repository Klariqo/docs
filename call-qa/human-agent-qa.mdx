...
description: "How Klariqo reviews human-agent VICIdial calls from the recording against the same scorecard, and attaches QA results to the signed compliance record."
---
